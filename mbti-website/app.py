...
RAW_QUESTIONS = [
    ...
    {
        'd': 'EI',
        'text': "当你在一个冷门币种上发现了巨大的潜在 Alpha（超额收益机会）时，你的第一反应是？",
        'a': "在核心圈子/私密群里分享，验证逻辑并享受共鸣",
        'b': "绝口不提，默默建仓，担心泄露导致流动性变差"
    },
    {
        'd': 'EI',
        'text': "遭遇连续亏损的“至暗时刻”，哪种方式能让你更快回血（心理上）？",
        'a': "找交易搭子吐槽，或者听听别人的惨痛经历",
        'b': "彻底断网，独自复盘日志，寻找系统漏洞"
    },
    {
        'd': 'EI',
        'text': "你更倾向于哪种交易环境？",
        'a': "热闹的 Trading Floor 或活跃的 Discord 语音频道",
        'b': "绝对安静、拉上窗帘、只有多屏幽光的独立空间"
    },
    {
        'd': 'EI',
        'text': "在牛市巅峰，你是倾向于？",
        'a': "呼朋唤友，组织聚会，享受高光时刻",
        'b': "感到一种人群狂热带来的深深孤独和警惕"
    },
    {
        'd': 'EI',
        'text': "交易对你来说，本质上是一场？",
        'a': "与全市场的博弈游戏 (PvP)，战胜对手才有快感",
        'b': "与自己内心的修炼 (PvE)，战胜贪婪才是关键"
    },
    {
        'd': 'EI',
        'text': "参加行业大会（如 Token2049 或 Consensus）时，你主要？",
        'a': "疯狂社交，交换 Telegram，寻找内幕消息",
        'b': "只听感兴趣的技术讲座，听完就走，拒绝无效社交"
    },
    {
        'd': 'EI',
        'text': "当推特（X）上出现全网 FUD（恐慌情绪）时，你会？",
        'a': "加入讨论，输出观点，甚至与人辩论",
        'b': "关闭社交媒体，只看链上数据和价格反应"
    },
    {
        'd': 'EI',
        'text': "你更喜欢哪种学习新策略的方式？",
        'a': "参加线下研讨会或直播课，能实时提问互动",
        'b': "阅读白皮书、API文档或经典交易书籍"
    },
    {
        'd': 'EI',
        'text': "你的交易灵感通常来自于？",
    ...
    {
        'd': 'EI',
        'text': "如果让你管理一支基金，你更希望？",
        'a': "组建明星团队，大家头脑风暴决策",
        'b': "拥有绝对控制权，通过算法或指令独自决策"
    },
    {
        'd': 'EI',
        'text': "对于“跟单交易（Copy Trading）”，你的看法是？",
        'a': "很有趣，既能赚钱又能社交",
        'b': "无法接受，我的钱必须由我自己控制"
    },
    {
        'd': 'EI',
        'text': "在长时间没有行情的“垃圾时间”，你会？",
        'a': "在群里水群，聊聊八卦和宏观",
        'b': "利用这段时间研究代码、回测数据或读书"
    },
    {
        'd': 'EI',
        'text': "你认为“影响力（Clout）”在交易中重要吗？",
        'a': "重要，能够喊单和组局是核心竞争力",
        'b': "不重要，只有 PnL（盈亏） 是真实的"
    },

    # --- S/N 感知维度：数据事实 vs 宏观叙事 ---
    {
        'd': 'SN',
        'text': "面对一张陌生的K线图，你的视线最先聚焦于？",
        'a': "当下的价格行为（Price Action）、成交量堆积和支撑位",
        'b': "图表走势背后的宏观周期位置和潜在的形态结构"
    },
    {
        'd': 'SN',
        'text': "对于“Web3”或“AI”这类新概念，你更看重？",
        'a': "具体的落地数据：日活用户(DAU)、营收财报、Gas消耗",
        'b': "未来的想象空间：它是否能改变人类协作范式或生产力"
    },
    {
        'd': 'SN',
        'text': "你认为所谓的“盘感”本质上是？",
        'a': "大脑对过往无数次微观历史行情的肌肉记忆",
        'b': "对市场群体情绪韵律的一种直觉共振"
    },
    {
        'd': 'SN',
        'text': "阅读一份长篇研报时，你更容易感到疲倦的是？",
        'a': "大段的宏观经济推演和抽象的未来展望",
        'b': "密密麻麻的链上数据表格和复杂的数学公式"
    },
    {
        'd': 'SN',
        'text': "你觉得目前原本的交易策略失效了，你会？",
        'a': "优化参数，调整指标灵敏度，修补细节",
        'b': "推倒重来，寻找新的市场范式和底层逻辑"
    },
    {
        'd': 'SN',
        'text': "你更倾向于交易哪种标的？",
        'a': "业绩稳定、有现金流的蓝筹股或主流币 (Value)",
        'b': "虽然现在亏损但概念极佳的成长股或早期代币 (Growth)"
    },
    {
        'd': 'SN',
        'text': "在技术分析中，你更信任？",
        'a': "确切的点位（如：0.618 回撤位，MA200）",
        'b': "模糊的形态（如：头肩底，圆弧底）"
    },
    {
        'd': 'SN',
        'text': "如果让你向别人介绍比特币，你会说？",
        'a': "它是一种基于 SHA-256 算法的去中心化账本",
        'b': "它是数字黄金，是针对法币通胀的保险单"
    },
    {
        'd': 'SN',
        'text': "做空时，你通常是因为？",
        'a': "价格跌破了关键支撑位，且量能放大",
        'b': "这个项目的逻辑根本跑不通，是个庞氏骗局"
    },
    {
        'd': 'SN',
        'text': "你更擅长记忆？",
    ...
    # --- T/F 判断维度：逻辑推演 vs 价值信仰 ---
    {
        'd': 'TF',
        'text': "你的重仓币种爆出了利空传闻，价格暴跌20%，你会？",
        'a': "逻辑是否破坏？是否触及止损线？机械离场",
        'b': "回顾项目愿景，如果初衷未变，这是加仓守护信仰的好机会"
    },
    {
        'd': 'TF',
        'text': "你认为一个顶级交易员的核心素质是？",
        'a': "像机器一样剔除人性，只做大概率正确的数学题",
        'b': "深刻理解人性贪婪与恐惧，并能利用这种情绪波动"
    },
    {
        'd': 'TF',
        'text': "当你不得不从一笔盈利的交易中提前下车时，通常是因为？",
        'a': "指标出现背离，或盈亏比不再划算",
        'b': "感觉不对劲，心里总有一种不安的预感"
    },
    {
        'd': 'TF',
        'text': "看到别人依靠“土狗/Meme”一夜暴富，你的真实心理是？",
        'a': "鄙视：这是赌博，不可持续，早晚归零",
        'b': "羡慕：虽不理解，但承认这也是一种市场共识的体现"
    },
    {
        'd': 'TF',
        'text': "如果要在这两个词中选一个刻在你的墓碑上，你选？",
        'a': "正确 (Right) - 战胜了市场",
        'b': "善良 (Kind) - 帮助了他人"
    },
    {
        'd': 'TF',
        'text': "假如你在通过内幕消息获利，你会感到？",
        'a': "毫无压力，这是信息差带来的合理回报",
        'b': "有些愧疚，觉得这对散户不公平"
    },
    {
        'd': 'TF',
        'text': "你评价一个交易策略好坏的标准是？",
        'a': "夏普比率（Sharpe Ratio）和最大回撤",
        'b': "是否让你睡得安稳，是否符合你的性格"
    },
    {
        'd': 'TF',
    ...
    },
    {
        'd': 'TF',
        'text': "你认为市场是？",
        'a': "有效的，或者是趋于有效的（Efficient）",
        'b': "非理性的，充满了情绪的泡沫"
    },
    {
        'd': 'TF',
        'text': "当你的判断和大多数人不一样时，你会觉得？",
        'a': "我是对的，真理掌握在少数人手中",
        'b': "我是不是漏看了什么？感到有些焦虑"
    },
    {
    ...
    {
        'd': 'TF',
        'text': "如果你开发了一个能稳定盈利但会伤害环境的算法，你会？",
        'a': "使用它，资本是逐利的",
        'b': "放弃它，这违背了我的价值观"
    },
    {
        'd': 'TF',
        'text': "你更喜欢哪种风格的 K线分析师？",
        'a': "冷峻客观，只讲数据，不带感情色彩",
        'b': "充满激情，富有感染力，像个布道者"
    },

    # --- J/P 生活方式：严谨体系 vs 灵活应变 ---
    {
        'd': 'JP',
        'text': "对于明天的重大宏观数据发布（如CPI/非农），你会？",
        'a': "提前推演三种剧本（涨/跌/盘整），并挂好对应的条件单",
        'b': "保持空仓或轻仓，等数据公布后的第一根K线走出来再随机应变"
    },
    {
        'd': 'JP',
        'text': "你的交易桌面或电脑文件通常是？",
        'a': "分类清晰，复盘表格井井有条，甚至是强迫症式的整洁",
        'b': "看似杂乱无章，遍布截图和草稿，但只有你知道核心信息在哪"
    },
    {
        'd': 'JP',
        'text': "你更喜欢哪种止盈策略？",
        'a': "左侧挂单：达到预设目标位严格止盈，绝不贪婪",
        'b': "右侧跟随：移动止损，让利润奔跑，直到趋势明确反转"
    },
    {
        'd': 'JP',
        'text': "如果是全职交易，你的一天通常？",
        'a': "像上班一样，有固定的看盘、健身、复盘时间表",
        'b': "昼夜颠倒，有行情就盯盘三天三夜，没行情就消失旅行"
    },
    {
        'd': 'JP',
        'text': "你更害怕？",
        'a': "失控 (Losing Control) - 计划被打乱",
        'b': "错过 (Missing Out) - 踏空行情"
    },
    {
        'd': 'JP',
        'text': "开单前，你必须？",
        'a': "写下完整的交易计划（入场、止损、止盈、仓位）",
        'b': "大致看一眼盈亏比，先进去再说，边走边看"
    },
    {
        'd': 'JP',
        'text': "对于“复利”的态度？",
        'a': "严格执行每日/每周的增长目标",
        'b': "看天吃饭，有的月份赚几十倍，有的月份休息"
    },
    {
        'd': 'JP',
        'text': "你的持仓周期通常是？",
        'a': "固定的，比如只做日内或只做周线级别",
        'b': "弹性的，赚钱了就拿久点，亏钱了就跑快点"
    },
    {
        'd': 'JP',
        'text': "如果今天你要出门办事，但行情很好，你会？",
        'a': "按原计划出门，不看盘或挂单处理",
        'b': "推迟出门，绝不能错过这波行情"
    },
    {
        'd': 'JP',
        'text': "你对于止损单（Stop Loss）的态度？",
        'a': "下单同时必设止损，雷打不动",
        'b': "心里有个止损价，到了再手动操作，怕被插针扫损"
    },
    {
        'd': 'JP',
        'text': "面对突发的黑天鹅事件，你的第一反应通常是？",
        'a': "僵住或按计划清仓",
        'b': "兴奋，迅速寻找其中的套利机会"
    },
    {
        'd': 'JP',
        'text': "你喜欢做“左侧交易”（预判顶底）还是“右侧交易”（顺势而为）？",
        'a': "偏向左侧，喜欢精准的狙击感",
        'b': "偏向右侧，喜欢确认后的安全感"
    },
    {
        'd': 'JP',
        'text': "当你的交易系统连续回撤时，你会？",
        'a': "停止交易，重新回测和修正规则",
...
REPORT_TEMPLATES = {
    ...
    'INTP': {
        ...
        'weaknesses': [
            ...
            "🤷‍♂️ 缺乏野心：容易满足于智力上的胜利而非账户金额的增长，缺乏做大规模的动力",
    ...
    'INFJ': {
        ...
        'strengths': [
            ...
            "🧘‍♂️ 长期主义：能够忍受漫长的寂寞，做时间的朋友，拿得住百倍股",
            "🛡️ 风险嗅觉：比起利润，你对危险的气味更敏感，擅长逃顶"
        ],
        'weaknesses': [
            "🌧️ 容易抑郁：亏损会给你带来巨大的心理创伤，甚至影响生活",
    ...
    'ENFJ': {
        ...
        'weaknesses': [
            ...
            "🗣️ 轻信他人：容易被包装精美的骗局项目方忽悠，甚至无意中成为帮凶"
        ],
    ...
    'ISTJ': {
        ...
        'strengths': [
            "🛡️ 绝对风控：你的字典里没有“爆仓”这两个字，止损线是你的生命线",
    ...
    'ISFJ': {
        ...
        'strengths': [
            ...
            "👁️ 细节控：能发现合同、规则或费率中的隐形陷阱，绝不会因为操作失误而亏钱",
    ...
    'ESTJ': {
        ...
        'strengths': [
            "⚔️ 顶级执行力：也是止损最果断的人群之一，绝不拖泥带水",
            "📅 完美记录：拥有像审计师一样的复盘账本，清楚知道每一分钱怎么赚/亏的",
            "🛡️ 严控回撤：绝不让单次亏损超过本金的 2%，风控是铁律"
        ],
        'weaknesses': [
    ...
    'ESFJ': {
        ...
        'strengths': [
            ...
            "🏃‍♂️ 跑得快：风向不对时，你是跑得最快的那批人，因为你对危险气氛很敏感"
        ],
        'weaknesses': [
    ...
    'ISTP': {
        ...
        'strengths': [
            ...
            "🛠️ 技术流：精通各种K线形态、指标和订单流 (Order Flow)，是工具的主人"
        ],
        'weaknesses': [
    ...
    'ISFP': {
        ...
        'weaknesses': [
            "🌧️ 容易崩坏：心态容易受生活琐事影响，和恋人吵架可能会导致你爆仓",
    ...
    'ESTP': {
        ...
        'strengths': [
            "🏎️ 速度之王：手速和脑速都极快，擅长抢帽子，在黑天鹅事件中能比别人快一步",
